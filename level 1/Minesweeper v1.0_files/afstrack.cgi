...
S+="&Tips="+T;
document.write("<a href=\"http://new.afsanalytics.com/?usr="+AFS_Account+"\" >");
...
bug.src="";
bug.src = AFS_Protocol +'//' + AFS_Server + '.afsanalytics.com/cgi-bin/click.cgi?usr=' + AFS_Account + '&exit='+encodeURIComponent(click);
afspause(20);
}
